                    ...
                    <div class="accordion-body">
                        <div class="py-4">
                            <h6 class="fw-bold">Youtube Video Url </h5>
                                <p>If you have an Youtube video that represents your activities as an event admin, add it in the standard format: https://www.youtube.com/watch?v=kPQ26-SbZi4</p>
